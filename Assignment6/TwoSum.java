...
public class TwoSum {
    ...
    public TwoSum() throws FileNotFoundException {
        ...
        for (long l : numbers){
            int invertedIndex = (int)((-l / table.RANGE) + 500000) / 2;
            for (int j = Math.max(0,invertedIndex-1); j<500000 && j <= invertedIndex + 1; j++){
